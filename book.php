...
<body>
    ...
    <a-scene embedded arjs>
        <a-marker preset="hiro">
            <a-text value="REGARDEZ LE LIVRE DE PHYSIQUE CHIMIE SGM !!!" position="0 0 0" color="white" background-color="black" rotation="-90 0 0" scale="1 1 1" align="center"></a-text>
        </a-marker>
